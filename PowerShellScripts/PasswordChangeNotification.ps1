...
foreach ($user in $notifyUsers)
{
    ...
    <p>    4.	Type your new password in the box labeled 'New Password' <br>
    <p>    5.	Retype new password in the box labeled 'Confirm Password' <br>
    <p>    6.	Press 'Enter' <br>
    <p>         a.	If you receive an error, make adjustments to your desired new password, then try again. <br> 
    <p>         b.	If you receive a message informing you the password was changed, you are done. <br> 
    <p> Method 2 (If your connection is over VPN): <br>
    <p>    1.	Double check that the VPN is connected. 
    <p>    2.	While logged in, press ctrl+alt+del on your keyboard. 
    <p>    3.	Click 'Change a Password' 
    <p>    4.	Type your current password in the box labeled 'Old Password'
    <p>    5.	Type your new password in the box labeled 'New Password'
    <p>    6.	Retype new password in the box labeled 'Confirm Password'
    <p>    7.	Press 'Enter' 
    <p>         a.	If you receive an error, make adjustments to your desired new password, then try again. 
    <p>         b.	If you receive a message informing you the password was changed, you are done. 
